...
The session-integrity overview was subsequently validated while automatically downloading from the gauge. Engineering Mode updated live and reported 3,527 completed transactions with zero retries, wire CRC errors, timeouts, recovered transactions, or final failures. The exported support bundle contained the same active-session totals and no detailed issue events.
